...
params:
  ...
  biography: "Biography"
  survey_url: "https://"
title: '`r sprintf("[Affiche Meetup Lille/Tunis R User Group] \"%s\" - %s - %s", params[["title"]], params[["author"]], params[["date"]])`'
pagetitle: Meetup
output: github_document
---

```{r text-fr, include = FALSE}
text_fr <- 'Les groupes R : Tunis et Lille organisent un nouveau MeetUp le %s avec %s !
%s
« %s » - %s
